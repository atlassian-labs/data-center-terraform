locals {
  ...
  sanitized_license  = replace(var.confluence_configuration["license"], "\n", "\\n")
  cmd_license_update = "sed -i 's|<property name=\"atlassian.license.message\">.*</property>|<property name=\"atlassian.license.message\">${local.sanitized_license}</property>|g' /shared-home/confluence.cfg.xml"
