...
# Only enable http port 80 with Nginx ingress controller. By default, Ingress controller listens on 443 and 80.
# Uncomment the below line to disable port 443 which will result in fewer inbound rules in Nginx controller security group
# in case you hit the limit which can happen if 30+ whitelist_cidrs are provided.
